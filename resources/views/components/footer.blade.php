    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between">
            <div class="mb-6 md:mb-0">
                ...
                <p class="text-gray-400">Blog ini adalah tempat untuk Belajar Membuat sebuah Website Sederhana!</p>
            </div>
            <div class="mb-6 md:mb-0">
        ...
        <div class="mt-10 border-t border-gray-700 pt-2 text-center">
            <p class="text-gray-400">&copy; 2025 Apris Agung Wiresa. Semua hak dilindungi.</p>
        </div>
    </div>
</footer>
