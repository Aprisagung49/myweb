<header class="absolute inset-x-0 top-0 z-50">
    ...
    <div x-data="{ open: false }" class="lg:hidden cursor-pointer" role="dialog" aria-modal="true">
      <!-- Background backdrop, show/hide based on slide-over state. -->
      <div @click="open = !open" class="fixed inset-0 z-50"></div>
      <div x-show ="open" class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          <a href="/" class="-m-1.5 p-1.5">
            <span class="sr-only">Your Company</span>
            <img class="h-8 w-auto" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="">
          </a>
          <button @click="open = !open" type="button" class="cursor-pointer -m-2.5 rounded-md p-2.5 text-gray-700">
